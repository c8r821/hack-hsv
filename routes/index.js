...
router.get('/', async function(req, res, next) {
    ...
    res.render('index', { title: 'Home', materials, submarines, styling: "min-height: 750vh; background-color: #91d5ff; background-image: url('/images/background.svg'); background-size: contain; background-position: 0 50vh; background-repeat: no-repeat"});
});
